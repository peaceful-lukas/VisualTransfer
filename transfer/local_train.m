function [W_retrained U_retrained param_new] = local_train(DS, W, U_new, param_new, trainTargetClasses)
...
U_retrained = local_learnU(DS, W_retrained, U_new, param_new, trainTargetClasses);

fprintf('Local LME RESULT\n');
fprintf('\tbefore\n');
[~, accuracy] = dispAccuracy('lme_new', 0, DS, W, U_new, param_new);
fprintf('\tafter\n');
[~, accuracy] = dispAccuracy('lme_new', 0, DS, W_retrained, U_retrained, param_new);
fprintf('\n\n\n\n');
